  ...
  <div class="container px-4 py-12 mx-auto">
    ...
    <section class="mb-16">
      <div class="flex items-center mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800">{{ $t("topList.movies") }}</h2>
      </div>
    ...
    <section>
      <div class="flex items-center mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-800">{{ $t("topList.tvShows") }}</h2>
      </div>
...
async function getTopMoive() {
  ...
  } = await axios.get(TOP_RATED_MOVIE_URL, {
    headers: {
